...
double CalculateAssetPrice(double S0, double U, double D, int n, int i); //input, display, and check model data
int GetInputData(double& S0, double& U, double& D, double& R); //validate input data for Binomial Tree Model
